...
vi.mock("./LiarsDiceConsole", () => ({
  LiarsDiceConsole: () => null,
}));
...
describe("Liar's Dice Player Departure", () => {
  it("advances turn or transitions to waiting when current turn player departs during bidding", () => {
